...
cat(paste("largest_driver_vaf","        ","largest_neutral_vaf","        ", "cooccurrence"),file="simulated_correlation_plot_Bolton_ages_logconvex_p2.txt",sep="\n")
...
cat(paste(largest_driver_vaf, "        ",largest_neutral_vaf,"        ", cooccurrence),file="simulated_correlation_plot_Bolton_ages_logconvex_p2.txt",append=TRUE, sep="\n")
cooccurrence = 'False'
