...
cat(paste("largest_driver_vaf","        ","largest_neutral_vaf","        ", "cooccurrence"),file="simulated_correlation_plot_Martincorena_ages.txt",sep="\n")
...
cat(paste(largest_driver_vaf, "        ",largest_neutral_vaf,"        ", cooccurrence),file="simulated_correlation_plot_Martincorena_ages.txt",append=TRUE, sep="\n")
cooccurrence = 'error'
